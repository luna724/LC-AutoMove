...
import luna724.iloveichika.automove.AutoMoveMod.Companion.ChatLib
...
fun changeDirection(
    ...
    val msg = "§6Changed direction to §a§l$moveDirections"
    println(msg)
    ChatLib.send(msg)
}

val keyBinds: IntArray
    get() {
